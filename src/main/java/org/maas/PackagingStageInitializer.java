...
public class PackagingStageInitializer extends Initializer {
    ...
    public String initialize(String scenarioDirectory) {
        ...
        {
        	agents.add(bakeryName + "-OrderProcessor:org.commitment_issues.delivery_agents.DummyOrderProcessor");
            agents.add(bakeryName + "-BakingAgent:org.commitment_issues.delivery_agents.DummyBakeAgent");
            agents.add(bakeryName + "-CoolingRack:org.commitment_issues.packaging_agents.GenericItemProcessor(cooling)");
            agents.add(bakeryName + "-ItemsProcessor:org.commitment_issues.packaging_agents.GenericItemProcessor");
            agents.add(bakeryName + "-PackagingAgent:org.commitment_issues.packaging_agents.PackagingAgent(bakery-001)");
    		agents.add(bakeryName + "-LoadingBayAgent:org.commitment_issues.delivery_agents.LoadingBayAgent");
        }
