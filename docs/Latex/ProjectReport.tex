...
\begin{enumerate}
	...
	\item Ensure that the EntryAgent is active by checking the file \textit{PackagingStageInitializer.java} \\(uncomment the line \textit{agents.add("EntryAgent:org.commitment\_issues.packaging\_agents.EntryAgent(" + scenarioDirectory + ")");} if it is commented)
